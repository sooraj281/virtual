...
const Hero = () => {
  return (
    <div className='flex flex-col items-center mt-6 lg:mt-20 px-40'>
      ...
      <p className='mt-10 text-lg text-center text-neutral-500 max-w-4xl'>
        Empower your creativity and bring your vr app ideas to life with our intuitive development tools. Get started today and turn your imagination
      </p>
